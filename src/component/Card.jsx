...
const handleShowUpdate = () => setShowUpdate(true);
  ...
  useEffect(() => {
    fetch('https://easy-cyan-mite-tam.cyclic.app/news')
      .then((res) => res.json())
      .then((result) => {
        setItems(result);
      });
  ...
  return (
    <div>
      ...
      {selectedUpdateItem && (<PopUpdate show={showUpdate} onHide={handleNewUpdateItem} item={selectedUpdateItem} />)}
    </div>
  );
}
